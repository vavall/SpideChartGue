...
class QuickChart {
  ...
  function __construct($options = array()) {
    $this->protocol = isset($options['protocol']) ? $options['protocol'] : 'http';
    $this->host = isset($options['host']) ? $options['host'] : 'quickchart';
    $this->port = isset($options['port']) ? $options['port'] : 3400;
